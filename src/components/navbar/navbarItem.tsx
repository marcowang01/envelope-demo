      ...
      <div
        className={clsx(
          ...
          hoverClass,
          {
            ...
            "bg-rose-400 text-white": pathName === "/newsletter" && path === "/newsletter",
            "bg-blue-500 text-white": pathName === "/apartment" && path === "/apartment",
            "bg-pink-500 text-white": pathName === "/job" && path === "/job",
            "bg-yellow-400 text-white": pathName === "/friends" && path === "/friends",
